	...
	$slidelink_2_metabox = array( 
		...
		'fields' => array(
					...
					array(
						...
						'desc' 			=> '',
						'id' 				=> 'Hely_slideDescript',
						'class' 			=> 'Hely_slideDescript',
						'type' 			=> 'text',
						'rich_editor' 	=> 0,			
						'max' 			=> 0				
					),
					array(
						'name' 			=> 'Slide alternative',
						'desc' 			=> '',
						'id' 				=> 'Hely_slideAlternative',
						'class' 			=> 'Hely_slideAlternative',
						'type' 			=> 'text',
						'rich_editor' 	=> 0,			
						'max' 			=> 0				
					),
					array(
						'name' 			=> 'Slide URL POST',
						'desc' 			=> '',
						'id' 				=> 'Hely_slideUrlPost',
						'class' 			=> 'Hely_slideUrlPost',
						'type' 			=> 'text',
						'rich_editor' 	=> 0,			
						'max' 			=> 0				
					)
